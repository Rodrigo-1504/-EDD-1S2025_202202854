...
{
    public class visualizarServicio : Window
    {
        ...
        // Singleton pattern
        private static visualizarServicio _instance;
        public static visualizarServicio Instance
        {
            get
            {
                if(_instance == null)
                {
                    _instance = new visualizarServicio();
                }
                return _instance;
            }
        }

        public visualizarServicio() : base("Mis Servicios")
        {
            try
            {
