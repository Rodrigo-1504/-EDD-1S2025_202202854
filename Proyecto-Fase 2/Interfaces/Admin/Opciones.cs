...
namespace Interfaces2
{
    public class Opciones : Window
    {
        ...
        private void goGestion(object sender, EventArgs e)
        {
            ...
            {
                Console.WriteLine($"Error al abrir Gestión de Entidades: {ex.Message}");
                ShowErrorMessage("Error al abrir la ventana de Gestión");
            }
        }
        ...
        private void goActualizacionR(object sender, EventArgs e)
        {
            ...
            {
                Console.WriteLine($"Error al abrir Actualización de Repuestos: {ex.Message}");
                ShowErrorMessage("Error al abrir la ventana de Actualización");
            }
        }
